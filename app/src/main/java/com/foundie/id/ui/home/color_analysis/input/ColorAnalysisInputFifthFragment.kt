...
import com.foundie.id.databinding.FragmentColorAnalysisInputFifthBinding
...
class ColorAnalysisInputFifthFragment : Fragment() {

    private var _binding: FragmentColorAnalysisInputFifthBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentColorAnalysisInputFifthBinding.inflate(inflater, container, false)
    ...
    private fun handleRadioButtonClick(number: Int) {
        ...
        val colorResList = when (number) {
            0 -> listOf(R.color.persona_blue_1)
            1 -> listOf(R.color.persone_blue_2)

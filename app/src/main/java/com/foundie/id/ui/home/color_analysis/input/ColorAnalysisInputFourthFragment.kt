...
import com.foundie.id.databinding.FragmentColorAnalysisInputFourthBinding
...
class ColorAnalysisInputFourthFragment : Fragment() {

    private var _binding: FragmentColorAnalysisInputFourthBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentColorAnalysisInputFourthBinding.inflate(inflater, container, false)
    ...
    private fun handleRadioButtonClick(number: Int) {
        ...
        val colorResList = when (number) {
            0 -> listOf(R.color.persona_green_1)
            1 -> listOf(R.color.persone_green_2)
